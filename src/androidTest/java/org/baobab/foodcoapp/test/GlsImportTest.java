...
public class GlsImportTest extends BaseProviderTests {
    ...
    public void testBarEinzahlung() {
        ...
        assertTrue(importer.getMsg().contains("Forderung beglichen: Bar Susi -> " + String.format("%.2f", 10f)));
        assertTrue(importer.getMsg().contains("Forderung beglichen: Bar Susi -> " + String.format("%.2f", 30f)));
    ...
    public void testRechnungBegleichen() {
        ...
        assertTrue(importer.getMsg().contains("Verbindlichkeit beglichen: " + "RefNr 123" + " -> " + String.format("%.2f", 23.42)));
